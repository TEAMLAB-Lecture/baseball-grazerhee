...
def is_validated_number(user_input_number):
    ...
    if is_digit(user_input_number) and is_between_100_and_999(user_input_number) \
        and is_duplicated_number(user_input_number)is False:
        result=True
    else:
        result=False
    # ==================================
...
def get_strikes_or_ball(user_input_number, random_number):
    ...
    strikes=0
    ball=0
    for ind_user in range(len(user_input_number)):
        for ind_rand in range(len(random_number)):
            if ind_rand==ind_user and user_input_number[ind_user]==random_number[ind_rand]:
                strikes += 1
            elif user_input_number[ind_user]==random_number[ind_rand]:
                ball += 1
